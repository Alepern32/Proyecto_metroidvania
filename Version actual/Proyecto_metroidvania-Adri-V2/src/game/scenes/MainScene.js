...
export default class MainScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.levelText = this.add.text(16, 50, "Nv.1", { fontSize: "10px", fill: "#ffdd44", stroke: "#000", strokeThickness: 2 }).setScrollFactor(0).setDepth(100);
    ...
    try {
      ...
      if (this.anims.exists(hurtAnim) && this.anims.exists(moveAnim)) {
        ...
        enemy.once("animationcomplete", (a) => {
          if (a.key === hurtAnim && enemy.active)
